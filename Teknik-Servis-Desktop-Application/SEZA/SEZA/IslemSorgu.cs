...
namespace SEZA
{
    public partial class IslemSorgu : Form
    {
        public IslemSorgu()
        {
            InitializeComponent();
        ...
        private DataView dv;
        private void MusteriCihazBilgisi_Load(object sender, EventArgs e)
        {
            // SqlDataAdapter nesnesi oluşturuluyor.
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM IslemSorgulama", connect);
